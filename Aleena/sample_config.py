#rename or edit this file.
import json
import os

def get_user_list(config, key):
    with open('{}/aleena/{}'.format(os.getcwd(), config), 'r') as json_file:
...
class Config(object):
    ...
    BAN_STICKER = 'CAACAgUAAxkBAAIHsl5nbqXdDTmpG2HFDNhnwvE5kFbWAAI9AQAC3pTNLzeTCUmnhTneGAQ'  # aleena #MassBan
