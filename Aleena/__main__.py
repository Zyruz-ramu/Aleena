...
*Main* commands available:
 ...
 - /help <module name>: for module info
 - /source: source code of this bot
 - /settings:
...
SOURCE_STRING = """
🖥 Developed on python3, im not an open source, but still you can request for my code @unitedbots - [WEBSITE](https://zyruzramu.wixsite.com/teamunited)
⚡
"""
...
def send_start(bot, update):
    ...
    keyboard = [[InlineKeyboardButton(text="Help",callback_data="help_back"),InlineKeyboardButton(text="🖥Developer",url="https://t.me/ram_uz")]]
    keyboard += [[InlineKeyboardButton(text="Connect chat", callback_data="main_connect"),InlineKeyboardButton(text="Add Me",url="t.me/{}?startgroup=true".format(bot.username))]]
...
def get_help(bot: Bot, update: Update):
    ...
    if chat.type != chat.PRIVATE:
        ...
        text = "Here is the available help for the *{}* module:\n".format(HELPABLE[module].__mod_name__) \
               + HELPABLE[module].__help__
        send_help(chat.id, text, InlineKeyboardMarkup([[InlineKeyboardButton(text="HELP", callback_data="help_back")]]))
